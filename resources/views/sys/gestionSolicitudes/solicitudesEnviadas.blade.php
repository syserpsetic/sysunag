...
@section('content_gs')
              ...
              <div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="row w-100 mx-0 auth-page">
                  <div class="col-md-8 col-xl-6 mx-auto d-flex flex-column align-items-center text-center">
                    ...
                    <!-- Ícono Feather -->
                    <i data-feather="send" class="text-muted mb-3" style="width: 100px; height: 100px; stroke-width: 1.5;"></i>

                    <h3 class="fw-bold mb-2 text-muted">Sin solicitudes enviadas</h3>
                    <h6 class="text-muted mb-3">Aún no has enviado ninguna solicitud. Cuando lo hagas, aparecerán aquí.</h6>
    ...
    <table class="jambo_table table table-hover"
        ...
        @foreach($solicitudes_enviadas as $row)
