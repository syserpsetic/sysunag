        ...
        <div class="card">
            ...
            <div class="alert alert-dark" role="alert">
                <h1 class="display-1 d-flex align-items-center">
                    <i data-feather="shuffle" class="me-3" style="width: 90px; height: 90px;"></i>
                    <strong>TRASLAPES</strong>
                </h1>
                <h4 class="lead bg-white"><div class="alert alert-fill-white" role="alert">Estudiantes con traslapes de asignaturas o módulos.</div></h4>
                <br>
                <div class="col-md-3">
                                ...
                                <table class="jambo_table table table-hover" id="tbl_malla_validaciones_estudiantes" border="1">
                                    <thead class="bg-primary">
                                        <tr class="headings">
                                            ...
                                            <th scope="col" class="text-white">Tipo Traslape</th>
                                            <th scope="col" class="text-white">Traslape</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="font-size: small;">
                                            ...
                                            <td scope="row">{{$row['tipo_traslape']}}</td>
                                            <td scope="row">{{$row['asignaturas_traslape']}}</td>
                                            <td scope="row"> - </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
