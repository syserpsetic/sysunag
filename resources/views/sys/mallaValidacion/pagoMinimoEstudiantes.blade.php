    ...
    <div class="col-12 col-md-12 col-xl-12">
        <div class="card">
            ...
            <div class="alert alert-dark" role="alert">
                ...
                <h4 class="lead bg-white"><div class="alert alert-fill-white" role="alert">Estudiantes con pago mínimo superior al saldo cargado.</div></h4>
                <br>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <a class="btn btn-success btn-sm" id="btn_actualizar_vista" type="button" title="Refrescar Vista Materializada">
                        <i data-feather="refresh-ccw" class="icon-sm me-2"></i> Actualizar Datos
                        </a>
                    </div>
                </div>
                                ...
                                <table class="jambo_table table table-hover" id="tbl_malla_validaciones_estudiantes" border="1">
                                    <thead  class="bg-primary">
                                        <tr class="headings">
                                            ...
                                            <th scope="col" class="text-white">Saldo Cargado</th>
                                            <th scope="col" class="text-white">Monto Pagado</th>
                                            <th scope="col" class="text-white">Saldo Actual</th>
                                            <th scope="col" class="text-white">Pago Mínimo</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr style="font-size: small;">
                                            ...
                                            <td scope="row">{{$row['saldo_cargado']}}</td>
                                            <td scope="row">{{$row['monto_pagado']}}</td>
                                            <td scope="row">{{$row['saldo_actual']}}</td>
                                            <td scope="row">{{$row['pago_minimo']}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
